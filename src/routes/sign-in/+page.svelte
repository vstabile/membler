...
<div class="flex min-h-screen w-full justify-center md:items-center md:bg-purple-100">
	<div class="w-full md:my-4 md:max-w-[520px]">
		<div
			class="m-auto flex min-h-screen w-full flex-col items-center border-gray-200 bg-white p-6 py-0 pt-10 md:min-h-[600px] md:rounded-2xl md:border md:p-12 md:py-10"
		>
